...
namespace Moodlight2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (redIntesity == 255) redCountingUp = false;
            if (redIntesity == 0) redCountingUp = true;
            if (redCountingUp) redIntesity++; else redIntesity--;
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            backgroundColor =
                new Color(redIntesity, blueIntensity, greenIntensity);
